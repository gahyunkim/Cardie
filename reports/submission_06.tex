...
Who is authorized: The current user has permission to get all Items in their feed\\
\begin{lstlisting}
GET /profile/:userid
\end{lstlisting} 
...
=======
\item The user sees all items in trending and not only the items in his own feed, this was our original plan but then we realized it does not make sense to show the user all the items because he will not be able to click on an item, that is not in his feed. 
...
>>>>>>> bddf2a56efba994335a8b938ba665b79b09a9e81
\end{itemize}
