...
\item \textbf{Roman Ganchin} \begin{itemize}
  \item Changed getCategories to work with actual database
  \item Changed getCategorySync to work with actual database
...
\item \textbf{Greg McGrath} \begin{itemize}
  \item Fixed getUserIdFromToken
  \item Changed getFeedData to work with updated database
  \item Fixed app.get(/user/:userid/feed)
  \item Changed getItem to work with actual database
